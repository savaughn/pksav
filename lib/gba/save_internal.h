...
// TODO: PRET and Bulbapedia disagree on National Dex unlocked. Which is right?
static const size_t PKSAV_GBA_SAVE_SECTION0_OFFSETS[][PKSAV_GBA_NUM_SECTION0_OFFSETS] =
{
    {0x0013,0x0014,0x0015,0x0018,0x0019,0x0028,0x005C,0x0098,0x00A0,0x00AC,0x00AC,0x00AC},
    {0x0013,0x0014,0x0015,0x0018,0x0019,0x0028,0x005C,0x0098,0x00A0,0x00AC,0x00AC,0x01F4},
    {0x0013,0x0014,0x0015,0x0018,0x001B,0x0028,0x005C,0x0098,0x00A0,0x00AC,0x0AF8,0x0F20}
};
