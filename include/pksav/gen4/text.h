 ...
 */
PKSAV_API enum pksav_error pksav_text_from_gen4(
 ...
 * \returns PKSAV_ERROR_NULL_POINTER if input_buffer or output_text is NULL
 */
PKSAV_API enum pksav_error pksav_widetext_from_gen4(
    const uint16_t* input_buffer,
    wchar_t* output_text,
    size_t num_chars
);
 ...
 */
PKSAV_API enum pksav_error pksav_text_to_gen4(
 ...
 * \returns PKSAV_ERROR_NULL_POINTER if input_text or output_buffer is NULL
 */
PKSAV_API enum pksav_error pksav_widetext_to_gen4(
