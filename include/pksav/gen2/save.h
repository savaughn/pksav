...
static PKSAV_INLINE void pksav_gen2_save_get_trainer_name_as_text(
    ...
    pksav_text_from_gen2(gen2_save->trainer_name, output_text, 7);
}

static PKSAV_INLINE void pksav_gen2_save_get_trainer_name_as_widetext(
    pksav_gen2_save_t* gen2_save,
    wchar_t* output_text
) {
    pksav_widetext_from_gen2(gen2_save->trainer_name, output_text, 7);
}

static PKSAV_INLINE void pksav_gen2_save_get_rival_name_as_text(
    pksav_gen2_save_t* gen2_save,
    char* output_text
) {
    pksav_text_from_gen2(gen2_save->rival_name, output_text, 7);
}

static PKSAV_INLINE void pksav_gen2_save_get_rival_name_as_widetext(
    pksav_gen2_save_t* gen2_save,
    wchar_t* output_text
) {
...
static PKSAV_INLINE void pksav_gen2_save_set_trainer_id(
    pksav_gen2_save_t* gen2_save,
    uint16_t trainer_id
) {
...
PKSAV_API pksav_error_t pksav_gen2_save_set_trainer_name_from_widetext(
    pksav_gen2_save_t* gen2_save,
    const wchar_t* trainer_name
);

PKSAV_API pksav_error_t pksav_gen2_save_set_rival_name_from_text(
    pksav_gen2_save_t* gen2_save,
    const char* rival_name
);

PKSAV_API pksav_error_t pksav_gen2_save_set_rival_name_from_widetext(
    pksav_gen2_save_t* gen2_save,
