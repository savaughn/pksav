 ...
 */
#ifndef pksav_gen3_TEXT_H
#define pksav_gen3_TEXT_H
 ...
 */
PKSAV_API enum pksav_error pksav_gen3_import_text(
 ...
 */
PKSAV_API enum pksav_error pksav_gen3_export_text(
