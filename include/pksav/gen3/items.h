 ...
 */
#ifndef pksav_gen3_ITEMS_H
#define pksav_gen3_ITEMS_H
...
#define pksav_gen3_ITEM_PC_NUM_ITEMS (50)

struct pksav_gen3_item_pc
{
    struct pksav_item items[pksav_gen3_ITEM_PC_NUM_ITEMS];
};

//! Internal represention of item storage in Pokémon Ruby/Sapphire.
struct pksav_gen3_rs_item_bag
{
...
struct pksav_gen3_emerald_item_bag
{
    //! Items stored in the Items pocket.
...
struct pksav_gen3_frlg_item_bag
{
    //! Items stored in the Items pocket.
 ...
 */
union pksav_gen3_item_bag
{
    //! Access to item storage in Pokémon Ruby/Sapphire.
    struct pksav_gen3_rs_item_bag rs;
    //! Access to item storage in Pokémon Emerald.
    struct pksav_gen3_emerald_item_bag emerald;
    //! Access to item storage in Pokémon FireRed/LeafGreen.
    struct pksav_gen3_frlg_item_bag frlg;
};

#pragma pack(pop)

#endif /* pksav_gen3_ITEMS_H */
